...
function AddTestMark() {
  ...
  return (
    <div className="app-container" style={{ maxWidth: '500px', margin: '50px auto', background: 'white', padding: '30px', borderRadius: '12px', boxShadow: '0 4px 6px rgba(0,0,0,0.1)' }}>
      ...
      {error && <div style={{ color: 'red', marginBottom: '20px', padding: '10px', background: '#fee2e2', borderRadius: '5px' }}>{error}</div>}
      {success && <div style={{ color: 'green', marginBottom: '20px', padding: '10px', background: '#dcfce7', borderRadius: '5px' }}>{success}</div>}
